...
class WeatherAnalyzer:
    ...
    def add_reading(self, date, max_temp, min_temp, max_humidity, mean_humidity):
    ...
    def parse_weather_file(self, file_path):
        with open(file_path, 'r') as file:
            ...
            for row in reader:
                ...
                self.add_reading(date, max_temp, min_temp, max_humidity, mean_humidity)
